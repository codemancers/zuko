...
export default function AddContactDialog({ accountId, existingContactIds }: AddContactDialogProps) {
  ...
  // Filter out contacts that are already associated with this account
  ...
  const addContactMutation = useMutation({
    mutationFn: () => {
      ...
      return accountsApi.addContact(accountId, {
    ...
    onError: (error: any) => {
      setErrors({ submit: error.message || "Failed to add contact to account" });
    },
  });
  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onClose={() => { setIsOpen(false); resetForm(); }}>
        ...
        <DialogDescription>
          Associate a contact with this account. Note: A contact can only be associated with one account at a time.
        </DialogDescription>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <Field>
                ...
                {availableContacts.length === 0 && (
                  <Description className="text-amber-600">
                    All contacts are already associated with this account.
                  </Description>
                )}
              ...
              <Field>
                ...
                <input
                  ...
                  disabled={addContactMutation.isPending}
                />
                <Description>Optional - e.g., Employee, Contractor, Advisor</Description>
              </Field>
              ...
              <Field>
                ...
                <Description>Mark as the main contact for this company</Description>
              </Field>
          ...
          <DialogActions>
            ...
            <Button
              type="submit"
              disabled={addContactMutation.isPending || availableContacts.length === 0}
            >
