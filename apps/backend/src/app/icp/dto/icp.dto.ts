...
export class IcpFiltersDto {
  ...
  @ApiPropertyOptional({ type: [String], example: ['north_america', 'europe'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  region?: string[];

  @ApiPropertyOptional({ type: [String], example: ['hr_tech', 'devtools'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  subIndustry?: string[];

  @ApiPropertyOptional({ type: [String], example: ['b2b', 'marketplace'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  companyType?: string[];

  @ApiPropertyOptional({ type: [String], example: ['growth', 'profitable'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['vc_funded', 'bootstrapped'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ type: [String], example: ['series_a', 'series_b'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  fundingStage?: string[];
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['Head of IT', 'Engineering Manager'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ type: [String], example: ['high'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['manual_data_entry', 'siloed_teams'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ type: [String], example: ['medium', 'high'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ type: [String], example: ['growth', 'mature'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ type: [String], example: ['competitor', 'partner'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
