...
- `libs/beads`: Integration with the Beads issue-tracking system.
...
3. AI chat endpoints orchestrate agent logic (from `libs/agents`) and can incorporate CRM context from `libs/sales`.
