/*
  ...
  - You are about to drop the `account_contact` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `account_owner` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `deal_account` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "sales"."account_contact" DROP CONSTRAINT "account_contact_account_id_fkey";

-- DropForeignKey
ALTER TABLE "sales"."account_contact" DROP CONSTRAINT "account_contact_contact_id_fkey";

-- DropForeignKey
ALTER TABLE "sales"."account_owner" DROP CONSTRAINT "account_owner_account_id_fkey";

-- DropForeignKey
ALTER TABLE "sales"."account_owner" DROP CONSTRAINT "account_owner_user_id_fkey";

-- DropForeignKey
ALTER TABLE "sales"."deal_account" DROP CONSTRAINT "deal_account_account_id_fkey";

-- DropForeignKey
ALTER TABLE "sales"."deal_account" DROP CONSTRAINT "deal_account_deal_id_fkey";

-- DropTable
DROP TABLE "sales"."account";

-- DropTable
DROP TABLE "sales"."account_contact";

-- DropTable
DROP TABLE "sales"."account_owner";

-- DropTable
DROP TABLE "sales"."deal_account";
